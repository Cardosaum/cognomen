...
## [0.5.1](https://github.com/Cardosaum/cognomen/compare/cognomen-v0.5.0...cognomen-v0.5.1) - 2026-08-21

### Added

- parse aliases and an explicit unknown variant ([#12](https://github.com/Cardosaum/cognomen/pull/12))

### Added

- variant `alias = "..."`: extra parse-in strings that do not change
